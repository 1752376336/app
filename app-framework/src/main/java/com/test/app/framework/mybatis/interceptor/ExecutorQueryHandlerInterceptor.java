package com.test.app.framework.mybatis.interceptor;

import com.test.app.framework.metadata.model.Model;
import com.test.app.framework.metadata.model.PageParam;
import com.test.app.framework.metadata.model.PageWrapper;
import com.test.app.framework.metadata.model.Sort;
import com.test.app.framework.mybatis.constant.Const;
import com.test.app.framework.mybatis.dialect.Dialect;
import com.test.app.framework.mybatis.dialect.DialectFactory;
import com.test.app.framework.mybatis.enums.MappingEnum;
import com.test.app.framework.mybatis.sqlsource.CustomerDynamicSqlSource;
import com.test.app.framework.mybatis.sqlsource.CustomerProviderSqlSource;
import com.test.app.framework.mybatis.utils.MetaObjectUtils;
import com.test.app.framework.mybatis.utils.MybatisUtils;
import com.test.app.framework.utils.SecurityUtils;
...
//        }
    ...
    private String getSortSql(List<Sort> sorts) {
        ...
        for (Sort sort : sorts) {
            builder.append(sort.getProperty()).append(" ").append(sort.getDirection().toUpperCase()).append(" ,");
        }
