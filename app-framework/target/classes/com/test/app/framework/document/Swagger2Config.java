package com.test.app.framework.document;
...
public class Swagger2Config {
    ...
    public Docket petApi() {
        ...
        parameters.add(new ParameterBuilder().name("Authorization").description("授权令牌").modelRef(new ModelRef("string")).parameterType("app").required(false).build());
